...
/** @var app\models\PesananSearchModel $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Data Pesanan');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pesanan-model-index">
                        ...
                        'buttons' => [
                            ...
                            'confirm' => function ($url, PesananModel $model, $key) {
                                return Html::a(
                                    ...
                                    ['pesanan/confirm-terkirim', 'id' => $model->id],
                                    [
                            ...
                            'verifikasi' => function ($url, PesananModel $model, $key) {
                                ...
                                $btnTransfer = Html::a(
                                    ...
                                    ['pesanan/verifikasi-transfer', 'id' => $tagihan->id],
                                    [
